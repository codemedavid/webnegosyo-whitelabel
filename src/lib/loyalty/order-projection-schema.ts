// Keep byte-for-byte aligned with the platform destination migration.
export const LOYALTY_ORDER_PROJECTION_SCHEMA = String.raw`-- This idempotent destination contract also ships in the tenant-order bundle.
