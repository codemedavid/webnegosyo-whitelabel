      ...
      <DialogContent className="w-[98vw] max-w-7xl max-h-[95vh] overflow-hidden p-0">
        ...
        <div className="bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-6 border-b">
          <DialogHeader className="space-y-3">
            ...
            {outletLabel && (
              <div className="flex items-center gap-2 rounded-md border border-violet-300 bg-violet-100 px-3 py-2 text-violet-900 dark:border-violet-700 dark:bg-violet-900/30 dark:text-violet-300">
