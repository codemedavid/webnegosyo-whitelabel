...
function RenderCountdown({ props }: { props: CountdownProps }) {
  // Start as null so the first client render matches the ISR-cached server HTML;
  // reading Date.now() during render would diverge and trigger a hydration
  // mismatch. Adopt the live clock only after mount.
