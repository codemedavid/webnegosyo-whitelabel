  ...
  return (
    <>
      <section className="relative overflow-hidden" style={{ backgroundColor: SMARTMENU.ink }}>
        ...
        <div className="relative mx-auto max-w-6xl px-5 py-12 md:px-8 md:py-28">
          ...
          <h1 className="font-display t-hero mt-5 max-w-3xl font-bold text-white">
          ...
          {courses.length > 0 ? (
            <dl className="mt-8 flex flex-wrap gap-x-10 gap-y-4 md:mt-10 md:gap-x-12">
            ...
            {groups.map((group) => (
              <section key={group.label}>
                <div className="mb-5 flex items-end justify-between gap-4 md:mb-6">
                  ...
                  <span className="inline-flex shrink-0 items-center gap-1.5 text-xs font-semibold sm:text-sm" style={{ color: SMARTMENU.cocoa }}>
...
function Stat({ value, label }: { value: string; label: string }) {
  return (
    <div className="shrink-0 whitespace-nowrap">
      <dt className="font-display text-2xl font-bold text-white md:text-3xl">{value}</dt>
